...
document.head.appendChild(lazyStyle);
    ...
    <?php print $styles ?>
      ...
      <link href="http://durmitor1.ru/sites/all/themes/goog/css/skrolr_bg.css" rel=stylesheet type="text/css">
...
<div class="wrapper">
  ...
  <script type="text/javascript" src="sites/all/themes/goog/js/skrollr.js"></script>
  <script type="text/javascript" src="sites/all/themes/goog/js/skroll_main.js"></script>
  <script type="text/javascript">
  jQuery(document).ready(function($) {
