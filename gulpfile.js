/* DURMITOR  if work with html set TRUE, else - FALSE
d:\Projects\durmitor\durmitor1.dev\sites\all\themes\goog\
*/
var htmlOWp = false,
  // set wordpress template folder
  wpThemeName = 'goog',
  // and set wordpress domain
  wpDomain = 'durmitor1.ru';
...
if (htmlOWp === true) {
  ...
  var basePaths = {
    src: 'assets/',
    dest: './durmitor1.ru/sites/all/themes/' + wpThemeName + '/'
  };
}
var paths = {
  images: {
